...
if(PyPRini.verbose_flag):
    print("PyPR_nuclear_rates.py: Interpolating nuclear rates")
    print(" ")
...
class UpdateNuclearRates(object):
    def __init__(self,p_npdg,p_dpHe3g,p_ddHe3n,p_ddtp,p_tpag,p_tdan,p_taLi7g, p_He3ntp,p_He3dap,p_He3aBe7g,p_Be7nLi7p,p_Li7paa,p_Li7paag,p_Be7naa,p_Be7daap,p_daLi6g,p_Li6pBe7g,p_Li6pHe3a, p_B8naap, p_Li6He3aap, p_Li6taan, p_Li6tLi8p, p_Li7He3Li6a, p_Li8He3Li7a, p_Be7tLi6a, p_B8tBe7a, p_B8nLi6He3, p_B8nBe7d, p_Li6tLi7d, p_Li6He3Be7d, p_Li7He3aad, p_Li8He3aat, p_Be7taad, p_Be7tLi7He3, p_B8dBe7He3, p_B8taaHe3, p_Be7He3ppaa, p_ddag, p_He3He3app, p_Be7pB8g, p_Li7daan, p_dntg, p_ttann, p_He3nag, p_He3tad, p_He3tanp, p_Li7taan, p_Li7He3aanp, p_Li8dLi7t, p_Be7taanp, p_Be7He3aapp, p_Li6nta, p_He3tLi6g, p_anpLi6g, p_Li6nLi7g, p_Li6dLi7p, p_Li6dBe7n, p_Li7nLi8g, p_Li7dLi8p, p_Li8paan, p_annHe6g, p_ppndp, p_Li7taann):
        npdg_mu = PyPRini.npdg_median*np.exp(p_npdg*np.log(PyPRini.npdg_expsigma))
        dpHe3g_mu = PyPRini.dpHe3g_median*np.exp(p_dpHe3g*np.log(PyPRini.dpHe3g_expsigma))
        ddHe3n_mu = PyPRini.ddHe3n_median*np.exp(p_ddHe3n*np.log(PyPRini.ddHe3n_expsigma))
        ddtp_mu = PyPRini.ddtp_median*np.exp(p_ddtp*np.log(PyPRini.ddtp_expsigma))
        tpag_mu = PyPRini.tpag_median*np.exp(p_tpag*np.log(PyPRini.tpag_expsigma))
        tdan_mu = PyPRini.tdan_median*np.exp(p_tdan*np.log(PyPRini.tdan_expsigma))
        taLi7g_mu = PyPRini.taLi7g_median*np.exp(p_taLi7g*np.log(PyPRini.taLi7g_expsigma))
        He3ntp_mu = PyPRini.He3ntp_median*np.exp(p_He3ntp*np.log(PyPRini.He3ntp_expsigma))
        He3dap_mu = PyPRini.He3dap_median*np.exp(p_He3dap*np.log(PyPRini.He3dap_expsigma))
        He3aBe7g_mu = PyPRini.He3aBe7g_median*np.exp(p_He3aBe7g*np.log(PyPRini.He3aBe7g_expsigma))
        Be7nLi7p_mu = PyPRini.Be7nLi7p_median*np.exp(p_Be7nLi7p*np.log(PyPRini.Be7nLi7p_expsigma))
        Li7paa_mu = PyPRini.Li7paa_median*np.exp(p_Li7paa*np.log(PyPRini.Li7paa_expsigma))
        Li7paag_mu = PyPRini.Li7paag_median*np.exp(p_Li7paag*np.log(PyPRini.Li7paag_expsigma))
        Be7naa_mu = PyPRini.Be7naa_median*np.exp(p_Be7naa*np.log(PyPRini.Be7naa_expsigma))
        Be7daap_mu = PyPRini.Be7daap_median*np.exp(p_Be7daap*np.log(PyPRini.Be7daap_expsigma))
        daLi6g_mu = PyPRini.daLi6g_median*np.exp(p_daLi6g*np.log(PyPRini.daLi6g_expsigma))
        Li6pBe7g_mu = PyPRini.Li6pBe7g_median*np.exp(p_Li6pBe7g*np.log(PyPRini.Li6pBe7g_expsigma))
        Li6pHe3a_mu = PyPRini.Li6pHe3a_median*np.exp(p_Li6pHe3a*np.log(PyPRini.Li6pHe3a_expsigma))
        B8naap_mu = PyPRini.B8naap_median*np.exp(p_B8naap*np.log(PyPRini.B8naap_expsigma))
        Li6He3aap_mu = PyPRini.Li6He3aap_median*np.exp(p_Li6He3aap*np.log(PyPRini.Li6He3aap_expsigma))
        Li6taan_mu = PyPRini.Li6taan_median*np.exp(p_Li6taan*np.log(PyPRini.Li6taan_expsigma))
        Li6tLi8p_mu = PyPRini.Li6tLi8p_median*np.exp(p_Li6tLi8p*np.log(PyPRini.Li6tLi8p_expsigma))
        Li7He3Li6a_mu = PyPRini.Li7He3Li6a_median*np.exp(p_Li7He3Li6a*np.log(PyPRini.Li7He3Li6a_expsigma))
        Li8He3Li7a_mu = PyPRini.Li8He3Li7a_median*np.exp(p_Li8He3Li7a*np.log(PyPRini.Li8He3Li7a_expsigma))
        Be7tLi6a_mu = PyPRini.Be7tLi6a_median*np.exp(p_Be7tLi6a*np.log(PyPRini.Be7tLi6a_expsigma))
        B8tBe7a_mu = PyPRini.B8tBe7a_median*np.exp(p_B8tBe7a*np.log(PyPRini.B8tBe7a_expsigma))
        B8nLi6He3_mu = PyPRini.B8nLi6He3_median*np.exp(p_B8nLi6He3*np.log(PyPRini.B8nLi6He3_expsigma))
        B8nBe7d_mu = PyPRini.B8nBe7d_median*np.exp(p_B8nBe7d*np.log(PyPRini.B8nBe7d_expsigma))
        Li6tLi7d_mu = PyPRini.Li6tLi7d_median*np.exp(p_Li6tLi7d*np.log(PyPRini.Li6tLi7d_expsigma))
        Li6He3Be7d_mu = PyPRini.Li6He3Be7d_median*np.exp(p_Li6He3Be7d*np.log(PyPRini.Li6He3Be7d_expsigma))
        Li7He3aad_mu = PyPRini.Li7He3aad_median*np.exp(p_Li7He3aad*np.log(PyPRini.Li7He3aad_expsigma))
        Li8He3aat_mu = PyPRini.Li8He3aat_median*np.exp(p_Li8He3aat*np.log(PyPRini.Li8He3aat_expsigma))
        Be7taad_mu = PyPRini.Be7taad_median*np.exp(p_Be7taad*np.log(PyPRini.Be7taad_expsigma))
        Be7tLi7He3_mu = PyPRini.Be7tLi7He3_median*np.exp(p_Be7tLi7He3*np.log(PyPRini.Be7tLi7He3_expsigma))
        B8dBe7He3_mu = PyPRini.B8dBe7He3_median*np.exp(p_B8dBe7He3*np.log(PyPRini.B8dBe7He3_expsigma))
        B8taaHe3_mu = PyPRini.B8taaHe3_median*np.exp(p_B8taaHe3*np.log(PyPRini.B8taaHe3_expsigma))
        Be7He3ppaa_mu = PyPRini.Be7He3ppaa_median*np.exp(p_Be7He3ppaa*np.log(PyPRini.Be7He3ppaa_expsigma))
        ddag_mu = PyPRini.ddag_median*np.exp(p_ddag*np.log(PyPRini.ddag_expsigma))
        He3He3app_mu = PyPRini.He3He3app_median*np.exp(p_He3He3app*np.log(PyPRini.He3He3app_expsigma))
        Be7pB8g_mu = PyPRini.Be7pB8g_median*np.exp(p_Be7pB8g*np.log(PyPRini.Be7pB8g_expsigma))
        Li7daan_mu = PyPRini.Li7daan_median*np.exp(p_Li7daan*np.log(PyPRini.Li7daan_expsigma))
        dntg_mu = PyPRini.dntg_median*np.exp(p_dntg*np.log(PyPRini.dntg_expsigma))
        ttann_mu = PyPRini.ttann_median*np.exp(p_ttann*np.log(PyPRini.ttann_expsigma))
        He3nag_mu = PyPRini.He3nag_median*np.exp(p_He3nag*np.log(PyPRini.He3nag_expsigma))
        He3tad_mu = PyPRini.He3tad_median*np.exp(p_He3tad*np.log(PyPRini.He3tad_expsigma))
        He3tanp_mu = PyPRini.He3tanp_median*np.exp(p_He3tanp*np.log(PyPRini.He3tanp_expsigma))
        Li7taan_mu = PyPRini.Li7taan_median*np.exp(p_Li7taan*np.log(PyPRini.Li7taan_expsigma))
        Li7He3aanp_mu = PyPRini.Li7He3aanp_median*np.exp(p_Li7He3aanp*np.log(PyPRini.Li7He3aanp_expsigma))
        Li8dLi7t_mu = PyPRini.Li8dLi7t_median*np.exp(p_Li8dLi7t*np.log(PyPRini.Li8dLi7t_expsigma))
        Be7taanp_mu = PyPRini.Be7taanp_median*np.exp(p_Be7taanp*np.log(PyPRini.Be7taanp_expsigma))
        Be7He3aapp_mu = PyPRini.Be7He3aapp_median*np.exp(p_Be7He3aapp*np.log(PyPRini.Be7He3aapp_expsigma))
        Li6nta_mu = PyPRini.Li6nta_median*np.exp(p_Li6nta*np.log(PyPRini.Li6nta_expsigma))
        He3tLi6g_mu = PyPRini.He3tLi6g_median*np.exp(p_He3tLi6g*np.log(PyPRini.He3tLi6g_expsigma))
        anpLi6g_mu = PyPRini.anpLi6g_median*np.exp(p_anpLi6g*np.log(PyPRini.anpLi6g_expsigma))
        Li6nLi7g_mu = PyPRini.Li6nLi7g_median*np.exp(p_Li6nLi7g*np.log(PyPRini.Li6nLi7g_expsigma))
        Li6dLi7p_mu = PyPRini.Li6dLi7p_median*np.exp(p_Li6dLi7p*np.log(PyPRini.Li6dLi7p_expsigma))
        Li6dBe7n_mu = PyPRini.Li6dBe7n_median*np.exp(p_Li6dBe7n*np.log(PyPRini.Li6dBe7n_expsigma))
        Li7nLi8g_mu = PyPRini.Li7nLi8g_median*np.exp(p_Li7nLi8g*np.log(PyPRini.Li7nLi8g_expsigma))
        Li7dLi8p_mu = PyPRini.Li7dLi8p_median*np.exp(p_Li7dLi8p*np.log(PyPRini.Li7dLi8p_expsigma))
        Li8paan_mu = PyPRini.Li8paan_median*np.exp(p_Li8paan*np.log(PyPRini.Li8paan_expsigma))
        annHe6g_mu = PyPRini.annHe6g_median*np.exp(p_annHe6g*np.log(PyPRini.annHe6g_expsigma))
        ppndp_mu = PyPRini.ppndp_median*np.exp(p_ppndp*np.log(PyPRini.ppndp_expsigma))
        Li7taann_mu = PyPRini.Li7taann_median*np.exp(p_Li7taann*np.log(PyPRini.Li7taann_expsigma))
        if(PyPRini.NP_nuclear_flag):
            npdg_mu += PyPRini.NP_delta_npdg*PyPRini.npdg_median
            dpHe3g_mu += PyPRini.NP_delta_dpHe3g*PyPRini.dpHe3g_median
            ddHe3n_mu += PyPRini.NP_delta_ddHe3n*PyPRini.ddHe3n_median
            ddtp_mu += PyPRini.NP_delta_ddtp*PyPRini.ddtp_median
            tpag_mu += PyPRini.NP_delta_tpag*PyPRini.tpag_median
            tdan_mu += PyPRini.NP_delta_tdan*PyPRini.tdan_median
            taLi7g_mu += PyPRini.NP_delta_taLi7g*PyPRini.taLi7g_median
            He3ntp_mu += PyPRini.NP_delta_He3ntp*PyPRini.He3ntp_median
            He3dap_mu += PyPRini.NP_delta_He3dap*PyPRini.He3dap_median
            He3aBe7g_mu += PyPRini.NP_delta_He3aBe7g*PyPRini.He3aBe7g_median
            Be7nLi7p_mu += PyPRini.NP_delta_Be7nLi7p*PyPRini.Be7nLi7p_median
            Li7paa_mu += PyPRini.NP_delta_Li7paa*PyPRini.Li7paa_median
            Li7paag_mu += PyPRini.NP_delta_Li7paag*PyPRini.Li7paag_median
            Be7naa_mu += PyPRini.NP_delta_Be7naa*PyPRini.Be7naa_median
            Be7daap_mu += PyPRini.NP_delta_Be7daap*PyPRini.Be7daap_median
            daLi6g_mu += PyPRini.NP_delta_daLi6g*PyPRini.daLi6g_median
            Li6pBe7g_mu += PyPRini.NP_delta_Li6pBe7g*PyPRini.Li6pBe7g_median
            Li6pHe3a_mu += PyPRini.NP_delta_Li6pHe3a*PyPRini.Li6pHe3a_median
            B8naap_mu += PyPRini.NP_delta_B8naap*PyPRini.B8naap_median
            Li6He3aap_mu += PyPRini.NP_delta_Li6He3aap*PyPRini.Li6He3aap_median
            Li6taan_mu += PyPRini.NP_delta_Li6taan*PyPRini.Li6taan_median
            Li6tLi8p_mu += PyPRini.NP_delta_Li6tLi8p*PyPRini.Li6tLi8p_median
            Li7He3Li6a_mu += PyPRini.NP_delta_Li7He3Li6a*PyPRini.Li7He3Li6a_median
            Li8He3Li7a_mu += PyPRini.NP_delta_Li8He3Li7a*PyPRini.Li8He3Li7a_median
            Be7tLi6a_mu += PyPRini.NP_delta_Be7tLi6a*PyPRini.Be7tLi6a_median
            B8tBe7a_mu += PyPRini.NP_delta_B8tBe7a*PyPRini.B8tBe7a_median
            B8nLi6He3_mu += PyPRini.NP_delta_B8nLi6He3*PyPRini.B8nLi6He3_median
            B8nBe7d_mu += PyPRini.NP_delta_B8nBe7d*PyPRini.B8nBe7d_median
            Li6tLi7d_mu += PyPRini.NP_delta_Li6tLi7d*PyPRini.Li6tLi7d_median
            Li6He3Be7d_mu += PyPRini.NP_delta_Li6He3Be7d*PyPRini.Li6He3Be7d_median
            Li7He3aad_mu += PyPRini.NP_delta_Li7He3aad*PyPRini.Li7He3aad_median
            Li8He3aat_mu += PyPRini.NP_delta_Li8He3aat*PyPRini.Li8He3aat_median
            Be7taad_mu += PyPRini.NP_delta_Be7taad*PyPRini.Be7taad_median
            Be7tLi7He3_mu += PyPRini.NP_delta_Be7tLi7He3*PyPRini.Be7tLi7He3_median
            B8dBe7He3_mu += PyPRini.NP_delta_B8dBe7He3*PyPRini.B8dBe7He3_median
            B8taaHe3_mu += PyPRini.NP_delta_B8taaHe3*PyPRini.B8taaHe3_median
            Be7He3ppaa_mu += PyPRini.NP_delta_Be7He3ppaa*PyPRini.Be7He3ppaa_median
            ddag_mu += PyPRini.NP_delta_ddag*PyPRini.ddag_median
            He3He3app_mu += PyPRini.NP_delta_He3He3app*PyPRini.He3He3app_median
            Be7pB8g_mu += PyPRini.NP_delta_Be7pB8g*PyPRini.Be7pB8g_median
            Li7daan_mu += PyPRini.NP_delta_Li7daan*PyPRini.Li7daan_median
            dntg_mu += PyPRini.NP_delta_dntg*PyPRini.dntg_median
            ttann_mu += PyPRini.NP_delta_ttann*PyPRini.ttann_median
            He3nag_mu += PyPRini.NP_delta_He3nag*PyPRini.He3nag_median
            He3tad_mu += PyPRini.NP_delta_He3tad*PyPRini.He3tad_median
            He3tanp_mu += PyPRini.NP_delta_He3tanp*PyPRini.He3tanp_median
            Li7taan_mu += PyPRini.NP_delta_Li7taan*PyPRini.Li7taan_median
            Li7He3aanp_mu += PyPRini.NP_delta_Li7He3aanp*PyPRini.Li7He3aanp_median
            Li8dLi7t_mu += PyPRini.NP_delta_Li8dLi7t*PyPRini.Li8dLi7t_median
            Be7taanp_mu += PyPRini.NP_delta_Be7taanp*PyPRini.Be7taanp_median
            Be7He3aapp_mu += PyPRini.NP_delta_Be7He3aapp*PyPRini.Be7He3aapp_median
            Li6nta_mu += PyPRini.NP_delta_Li6nta*PyPRini.Li6nta_median
            He3tLi6g_mu += PyPRini.NP_delta_He3tLi6g*PyPRini.He3tLi6g_median
            anpLi6g_mu += PyPRini.NP_delta_anpLi6g*PyPRini.anpLi6g_median
            Li6nLi7g_mu += PyPRini.NP_delta_Li6nLi7g*PyPRini.Li6nLi7g_median
            Li6dLi7p_mu += PyPRini.NP_delta_Li6dLi7p*PyPRini.Li6dLi7p_median
            Li6dBe7n_mu += PyPRini.NP_delta_Li6dBe7n*PyPRini.Li6dBe7n_median
            Li7nLi8g_mu += PyPRini.NP_delta_Li7nLi8g*PyPRini.Li7nLi8g_median
            Li7dLi8p_mu += PyPRini.NP_delta_Li7dLi8p*PyPRini.Li7dLi8p_median
            Li8paan_mu += PyPRini.NP_delta_Li8paan*PyPRini.Li8paan_median
            annHe6g_mu += PyPRini.NP_delta_annHe6g*PyPRini.annHe6g_median
            ppndp_mu += PyPRini.NP_delta_ppndp*PyPRini.ppndp_median
            Li7taann_mu += PyPRini.NP_delta_Li7taann*PyPRini.Li7taann_median
        self.npdg_spline = interp1d(PyPRini.npdg_T9,npdg_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.dpHe3g_spline = interp1d(PyPRini.dpHe3g_T9,dpHe3g_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.ddHe3n_spline = interp1d(PyPRini.ddHe3n_T9,ddHe3n_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.ddtp_spline = interp1d(PyPRini.ddtp_T9,ddtp_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.tpag_spline = interp1d(PyPRini.tpag_T9,tpag_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.tdan_spline = interp1d(PyPRini.tdan_T9,tdan_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.taLi7g_spline = interp1d(PyPRini.taLi7g_T9,taLi7g_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.He3ntp_spline = interp1d(PyPRini.He3ntp_T9,He3ntp_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.He3dap_spline = interp1d(PyPRini.He3dap_T9,He3dap_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.He3aBe7g_spline = interp1d(PyPRini.He3aBe7g_T9,He3aBe7g_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Be7nLi7p_spline = interp1d(PyPRini.Be7nLi7p_T9,Be7nLi7p_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li7paa_spline = interp1d(PyPRini.Li7paa_T9,Li7paa_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li7paag_spline = interp1d(PyPRini.Li7paag_T9,Li7paag_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Be7naa_spline = interp1d(PyPRini.Be7naa_T9,Be7naa_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Be7daap_spline = interp1d(PyPRini.Be7daap_T9,Be7daap_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.daLi6g_spline = interp1d(PyPRini.daLi6g_T9,daLi6g_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li6pBe7g_spline = interp1d(PyPRini.Li6pBe7g_T9,Li6pBe7g_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li6pHe3a_spline = interp1d(PyPRini.Li6pHe3a_T9,Li6pHe3a_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.B8naap_spline = interp1d(PyPRini.B8naap_T9,B8naap_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li6He3aap_spline = interp1d(PyPRini.Li6He3aap_T9,Li6He3aap_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li6taan_spline = interp1d(PyPRini.Li6taan_T9,Li6taan_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li6tLi8p_spline = interp1d(PyPRini.Li6tLi8p_T9,Li6tLi8p_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li7He3Li6a_spline = interp1d(PyPRini.Li7He3Li6a_T9,Li7He3Li6a_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li8He3Li7a_spline = interp1d(PyPRini.Li8He3Li7a_T9,Li8He3Li7a_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Be7tLi6a_spline = interp1d(PyPRini.Be7tLi6a_T9,Be7tLi6a_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.B8tBe7a_spline = interp1d(PyPRini.B8tBe7a_T9,B8tBe7a_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.B8nLi6He3_spline = interp1d(PyPRini.B8nLi6He3_T9,B8nLi6He3_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.B8nBe7d_spline = interp1d(PyPRini.B8nBe7d_T9,B8nBe7d_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li6tLi7d_spline = interp1d(PyPRini.Li6tLi7d_T9,Li6tLi7d_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li6He3Be7d_spline = interp1d(PyPRini.Li6He3Be7d_T9,Li6He3Be7d_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li7He3aad_spline = interp1d(PyPRini.Li7He3aad_T9,Li7He3aad_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li8He3aat_spline = interp1d(PyPRini.Li8He3aat_T9,Li8He3aat_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Be7taad_spline = interp1d(PyPRini.Be7taad_T9,Be7taad_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Be7tLi7He3_spline = interp1d(PyPRini.Be7tLi7He3_T9,Be7tLi7He3_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.B8dBe7He3_spline = interp1d(PyPRini.B8dBe7He3_T9,B8dBe7He3_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.B8taaHe3_spline = interp1d(PyPRini.B8taaHe3_T9,B8taaHe3_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Be7He3ppaa_spline = interp1d(PyPRini.Be7He3ppaa_T9,Be7He3ppaa_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.ddag_spline = interp1d(PyPRini.ddag_T9,ddag_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.He3He3app_spline = interp1d(PyPRini.He3He3app_T9,He3He3app_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Be7pB8g_spline = interp1d(PyPRini.Be7pB8g_T9,Be7pB8g_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.Li7daan_spline = interp1d(PyPRini.Li7daan_T9,Li7daan_mu,bounds_error=False,fill_value="extrapolate",kind='linear')
        self.dntg_spline = interp1d(PyPRini.dntg_T9,dntg_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.ttann_spline = interp1d(PyPRini.ttann_T9,ttann_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.He3nag_spline = interp1d(PyPRini.He3nag_T9,He3nag_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.He3tad_spline = interp1d(PyPRini.He3tad_T9,He3tad_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.He3tanp_spline = interp1d(PyPRini.He3tanp_T9,He3tanp_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li7taan_spline = interp1d(PyPRini.Li7taan_T9,Li7taan_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li7He3aanp_spline = interp1d(PyPRini.Li7He3aanp_T9,Li7He3aanp_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li8dLi7t_spline = interp1d(PyPRini.Li8dLi7t_T9,Li8dLi7t_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Be7taanp_spline = interp1d(PyPRini.Be7taanp_T9,Be7taanp_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Be7He3aapp_spline = interp1d(PyPRini.Be7He3aapp_T9,Be7He3aapp_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li6nta_spline = interp1d(PyPRini.Li6nta_T9,Li6nta_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.He3tLi6g_spline = interp1d(PyPRini.He3tLi6g_T9,He3tLi6g_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.anpLi6g_spline = interp1d(PyPRini.anpLi6g_T9,anpLi6g_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li6nLi7g_spline = interp1d(PyPRini.Li6nLi7g_T9,Li6nLi7g_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li6dLi7p_spline = interp1d(PyPRini.Li6dLi7p_T9,Li6dLi7p_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li6dBe7n_spline = interp1d(PyPRini.Li6dBe7n_T9,Li6dBe7n_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li7nLi8g_spline = interp1d(PyPRini.Li7nLi8g_T9,Li7nLi8g_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li7dLi8p_spline = interp1d(PyPRini.Li7dLi8p_T9,Li7dLi8p_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li8paan_spline = interp1d(PyPRini.Li8paan_T9,Li8paan_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.annHe6g_spline = interp1d(PyPRini.annHe6g_T9,annHe6g_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.ppndp_spline = interp1d(PyPRini.ppndp_T9,ppndp_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
        self.Li7taann_spline = interp1d(PyPRini.Li7taann_T9,Li7taann_mu,bounds_error=False,fill_value="extrapolate",kind='quadratic')
    ...
    def npdg_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_npdg
        beta = PyPRini.beta_npdg
        gamma = PyPRini.gamma_npdg
    ...
    def dpHe3g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_dpHe3g
        beta = PyPRini.beta_dpHe3g
        gamma = PyPRini.gamma_dpHe3g
    ...
    def ddHe3n_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_ddHe3n
        beta = PyPRini.beta_ddHe3n
        gamma = PyPRini.gamma_ddHe3n
    ...
    def ddtp_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_ddtp
        beta = PyPRini.beta_ddtp
        gamma = PyPRini.gamma_ddtp
    ...
    def tpag_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_tpag
        beta = PyPRini.beta_tpag
        gamma = PyPRini.gamma_tpag
    ...
    def tdan_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_tdan
        beta = PyPRini.beta_tdan
        gamma = PyPRini.gamma_tdan
    ...
    def taLi7g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_taLi7g
        beta = PyPRini.beta_taLi7g
        gamma = PyPRini.gamma_taLi7g
    ...
    def He3ntp_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_He3ntp
        beta = PyPRini.beta_He3ntp
        gamma = PyPRini.gamma_He3ntp
    ...
    def He3dap_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_He3dap
        beta = PyPRini.beta_He3dap
        gamma = PyPRini.gamma_He3dap
    ...
    def He3aBe7g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_He3aBe7g
        beta = PyPRini.beta_He3aBe7g
        gamma = PyPRini.gamma_He3aBe7g
    ...
    def Be7nLi7p_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7nLi7p
        beta = PyPRini.beta_Be7nLi7p
        gamma = PyPRini.gamma_Be7nLi7p
    ...
    def Li7paa_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7paa
        beta = PyPRini.beta_Li7paa
        gamma = PyPRini.gamma_Li7paa
    ...
    def Li7paag_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7paag
        beta = PyPRini.beta_Li7paag
        gamma = PyPRini.gamma_Li7paag
    ...
    def Be7naa_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7naa
        beta = PyPRini.beta_Be7naa
        gamma = PyPRini.gamma_Be7naa
    ...
    def Be7daap_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7daap
        beta = PyPRini.beta_Be7daap
        gamma = PyPRini.gamma_Be7daap
    ...
    def daLi6g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_daLi6g
        beta = PyPRini.beta_daLi6g
        gamma = PyPRini.gamma_daLi6g
    ...
    def Li6pBe7g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6pBe7g
        beta = PyPRini.beta_Li6pBe7g
        gamma = PyPRini.gamma_Li6pBe7g
    ...
    def Li6pHe3a_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6pHe3a
        beta = PyPRini.beta_Li6pHe3a
        gamma = PyPRini.gamma_Li6pHe3a
    ...
    def B8naap_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_B8naap
        beta = PyPRini.beta_B8naap
        gamma = PyPRini.gamma_B8naap
    ...
    def Li6He3aap_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6He3aap
        beta = PyPRini.beta_Li6He3aap
        gamma = PyPRini.gamma_Li6He3aap
    ...
    def Li6taan_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6taan
        beta = PyPRini.beta_Li6taan
        gamma = PyPRini.gamma_Li6taan
    ...
    def Li6tLi8p_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6tLi8p
        beta = PyPRini.beta_Li6tLi8p
        gamma = PyPRini.gamma_Li6tLi8p
    ...
    def Li7He3Li6a_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7He3Li6a
        beta = PyPRini.beta_Li7He3Li6a
        gamma = PyPRini.gamma_Li7He3Li6a
    ...
    def Li8He3Li7a_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li8He3Li7a
        beta = PyPRini.beta_Li8He3Li7a
        gamma = PyPRini.gamma_Li8He3Li7a
    ...
    def Be7tLi6a_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7tLi6a
        beta = PyPRini.beta_Be7tLi6a
        gamma = PyPRini.gamma_Be7tLi6a
    ...
    def B8tBe7a_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_B8tBe7a
        beta = PyPRini.beta_B8tBe7a
        gamma = PyPRini.gamma_B8tBe7a
    ...
    def B8nLi6He3_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_B8nLi6He3
        beta = PyPRini.beta_B8nLi6He3
        gamma = PyPRini.gamma_B8nLi6He3
    ...
    def B8nBe7d_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_B8nBe7d
        beta = PyPRini.beta_B8nBe7d
        gamma = PyPRini.gamma_B8nBe7d
    ...
    def Li6tLi7d_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6tLi7d
        beta = PyPRini.beta_Li6tLi7d
        gamma = PyPRini.gamma_Li6tLi7d
    ...
    def Li6He3Be7d_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6He3Be7d
        beta = PyPRini.beta_Li6He3Be7d
        gamma = PyPRini.gamma_Li6He3Be7d
    ...
    def Li7He3aad_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7He3aad
        beta = PyPRini.beta_Li7He3aad
        gamma = PyPRini.gamma_Li7He3aad
    ...
    def Li8He3aat_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li8He3aat
        beta = PyPRini.beta_Li8He3aat
        gamma = PyPRini.gamma_Li8He3aat
    ...
    def Be7taad_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7taad
        beta = PyPRini.beta_Be7taad
        gamma = PyPRini.gamma_Be7taad
    ...
    def Be7tLi7He3_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7tLi7He3
        beta = PyPRini.beta_Be7tLi7He3
        gamma = PyPRini.gamma_Be7tLi7He3
    ...
    def B8dBe7He3_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_B8dBe7He3
        beta = PyPRini.beta_B8dBe7He3
        gamma = PyPRini.gamma_B8dBe7He3
    ...
    def B8taaHe3_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_B8taaHe3
        beta = PyPRini.beta_B8taaHe3
        gamma = PyPRini.gamma_B8taaHe3
    ...
    def Be7He3ppaa_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7He3ppaa
        beta = PyPRini.beta_Be7He3ppaa
        gamma = PyPRini.gamma_Be7He3ppaa
    ...
    def ddag_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_ddag
        beta = PyPRini.beta_ddag
        gamma = PyPRini.gamma_ddag
    ...
    def He3He3app_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_He3He3app
        beta = PyPRini.beta_He3He3app
        gamma = PyPRini.gamma_He3He3app
    ...
    def Be7pB8g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7pB8g
        beta = PyPRini.beta_Be7pB8g
        gamma = PyPRini.gamma_Be7pB8g
    ...
    def Li7daan_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7daan
        beta = PyPRini.beta_Li7daan
        gamma = PyPRini.gamma_Li7daan
    ...
    def dntg_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_dntg
        beta = PyPRini.beta_dntg
        gamma = PyPRini.gamma_dntg
    ...
    def ttann_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_ttann
        beta = PyPRini.beta_ttann
        gamma = PyPRini.gamma_ttann
    ...
    def He3nag_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_He3nag
        beta = PyPRini.beta_He3nag
        gamma = PyPRini.gamma_He3nag
    ...
    def He3tad_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_He3tad
        beta = PyPRini.beta_He3tad
        gamma = PyPRini.gamma_He3tad
    ...
    def He3tanp_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_He3tanp
        beta = PyPRini.beta_He3tanp
        gamma = PyPRini.gamma_He3tanp
    ...
    def Li7taan_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7taan
        beta = PyPRini.beta_Li7taan
        gamma = PyPRini.gamma_Li7taan
    ...
    def Li7He3aanp_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7He3aanp
        beta = PyPRini.beta_Li7He3aanp
        gamma = PyPRini.gamma_Li7He3aanp
    ...
    def Li8dLi7t_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li8dLi7t
        beta = PyPRini.beta_Li8dLi7t
        gamma = PyPRini.gamma_Li8dLi7t
    ...
    def Be7taanp_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7taanp
        beta = PyPRini.beta_Be7taanp
        gamma = PyPRini.gamma_Be7taanp
    ...
    def Be7He3aapp_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Be7He3aapp
        beta = PyPRini.beta_Be7He3aapp
        gamma = PyPRini.gamma_Be7He3aapp
    ...
    def Li6nta_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6nta
        beta = PyPRini.beta_Li6nta
        gamma = PyPRini.gamma_Li6nta
    ...
    def He3tLi6g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_He3tLi6g
        beta = PyPRini.beta_He3tLi6g
        gamma = PyPRini.gamma_He3tLi6g
    ...
    def anpLi6g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_anpLi6g
        beta = PyPRini.beta_anpLi6g
        gamma = PyPRini.gamma_anpLi6g
    ...
    def Li6nLi7g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6nLi7g
        beta = PyPRini.beta_Li6nLi7g
        gamma = PyPRini.gamma_Li6nLi7g
    ...
    def Li6dLi7p_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6dLi7p
        beta = PyPRini.beta_Li6dLi7p
        gamma = PyPRini.gamma_Li6dLi7p
    ...
    def Li6dBe7n_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li6dBe7n
        beta = PyPRini.beta_Li6dBe7n
        gamma = PyPRini.gamma_Li6dBe7n
    ...
    def Li7nLi8g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7nLi8g
        beta = PyPRini.beta_Li7nLi8g
        gamma = PyPRini.gamma_Li7nLi8g
    ...
    def Li7dLi8p_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7dLi8p
        beta = PyPRini.beta_Li7dLi8p
        gamma = PyPRini.gamma_Li7dLi8p
    ...
    def Li8paan_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li8paan
        beta = PyPRini.beta_Li8paan
        gamma = PyPRini.gamma_Li8paan
    ...
    def annHe6g_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_annHe6g
        beta = PyPRini.beta_annHe6g
        gamma = PyPRini.gamma_annHe6g
    ...
    def ppndp_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_ppndp
        beta = PyPRini.beta_ppndp
        gamma = PyPRini.gamma_ppndp
    ...
    def Li7taann_bkwrd(self,T):
        T9 = T*1.e-9
        alpha = PyPRini.alpha_Li7taann
        beta = PyPRini.beta_Li7taann
        gamma = PyPRini.gamma_Li7taann
